...
ruta_resultados_html <- paste0(ruta_resultados, "html/")
...
if (!dir.exists(ruta_resultados_html)) {
  dir.create(ruta_resultados_html)
}
...
print("Tablas visuales PNG:")
print(list.files(ruta_resultados_png))

print("Tablas visuales HTML:")
print(list.files(ruta_resultados_html))

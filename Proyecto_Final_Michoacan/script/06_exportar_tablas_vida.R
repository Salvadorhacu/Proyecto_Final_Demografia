...
ruta_resultados_csv <- paste0(ruta_resultados, "csv/")

if (!dir.exists(ruta_resultados)) {
  dir.create(ruta_resultados)
}

if (!dir.exists(ruta_resultados_csv)) {
  dir.create(ruta_resultados_csv)
}
...
fwrite(
  tabla_final,
  paste0(ruta_resultados_csv, "tabla_vida_completa_michoacan_2010_2019_2021.csv")
)
...
fwrite(
  esperanza_final,
  paste0(ruta_resultados_csv, "resumen_esperanza_vida_michoacan.csv")
)
...
print(list.files(ruta_resultados_csv))

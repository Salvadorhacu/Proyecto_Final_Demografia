...
![Esperanza de vida al nacer](Proyecto_Final_Michoacan/output/esperanza_vida_michoacan.png)

![Tasas centrales de mortalidad](Proyecto_Final_Michoacan/output/mx_michoacan.png)

![Probabilidades de muerte](Proyecto_Final_Michoacan/output/qx_michoacan.png)

![Sobrevivientes](Proyecto_Final_Michoacan/output/lx_michoacan.png)

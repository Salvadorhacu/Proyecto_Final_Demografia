...
```{mermaid}
flowchart TD
    A[Inicio] --> B[Datos de población y defunciones INEGI]
    B --> C[Limpieza de población censal 2010 y 2020]
    C --> D[Prorrateo de población con edad no especificada]
    D --> E[Limpieza de defunciones registradas]
    E --> F[Prorrateo de defunciones con sexo no especificado]
    F --> G[Agrupación de defunciones por año de referencia]
    G --> H[Cálculo de APV mediante crecimiento exponencial]
    H --> I[Cálculo de tasas centrales de mortalidad nmx]
    I --> J[Construcción de tablas de vida]
    J --> K[Cálculo de esperanza de vida al nacer]
    K --> L[Generación de gráficas]
    L --> M[Exportación de tablas de vida finales]
...
\[
r=\frac{\ln\left(\frac{N_T}{N_0}\right)}{t_T-t_0}
\]
...
\begin{cases}
0.330, & \text{si } m_0 \geq 0.107 \\
0.045+2.684m_0, & \text{si } m_0<0.107
\end{cases}
...
\begin{cases}
1.352, & \text{si } m_0 \geq 0.107 \\
1.651-2.816m_0, & \text{si } m_0<0.107
\end{cases}
...
\begin{cases}
0.350, & \text{si } m_0 \geq 0.107 \\
0.053+2.800m_0, & \text{si } m_0<0.107
\end{cases}
...
\begin{cases}
1.361, & \text{si } m_0 \geq 0.107 \\
1.522-1.518m_0, & \text{si } m_0<0.107
\end{cases}
...
\[ {}*n L_x=n*\cdot l{x+n}+{}\_n a_x\cdot {}\_n d_x \]
